"use strict";(()=>{var e={};e.id=5817,e.ids=[5817],e.modules={38013:e=>{e.exports=require("mongodb")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},1164:(e,t,a)=>{a.r(t),a.d(t,{originalPathname:()=>E,patchFetch:()=>f,requestAsyncStorage:()=>p,routeModule:()=>u,serverHooks:()=>g,staticGenerationAsyncStorage:()=>m});var r={};a.r(r),a.d(r,{GET:()=>c,POST:()=>d});var n=a(49303),o=a(88716),i=a(60670),s=a(87070),l=a(24544);async function c(){try{let e=await l.Z.getConnection(),[t]=await e.execute("SELECT * FROM profit_ledger ORDER BY id DESC"),a=`
      SELECT 
        id,
        bill_date,
        customer_name,
